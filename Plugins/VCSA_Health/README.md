...
- **1.1.3**: where the monitoring account cannot read the list of available updates, the update check now falls back to the appliance's own status field and reports the limitation as a detail, rather than reporting the service as unknown
